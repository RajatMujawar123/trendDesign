...
const TexturedTShirt = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://trend-design.vercel.app/getTshirtsCategoryWise/${category}`)
      .then((response) => {
  ...
  return (
     <div>
      <h1 className="CategoryHead">Textured T-Shirts</h1>
